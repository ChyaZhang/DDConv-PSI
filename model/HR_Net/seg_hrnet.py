...
class Conv2d_cd(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size=3, stride=1,
                 padding=1, dilation=1, groups=1, bias=False, theta=0.9):
...
class DeformConv2dcd(nn.Module):
    def __init__(self, inc, outc, kernel_size=3, padding=1, stride=1, bias=None, modulation=False):
        """
        Args:
            modulation (bool, optional): If True, Modulated Defomable Convolution (Deformable ConvNets v2).
        """
        super(DeformConv2dcd, self).__init__()
        self.kernel_size = kernel_size
        self.padding = padding
        self.stride = stride
        self.zero_padding = nn.ZeroPad2d(padding)
        ...
        self.p_conv = Conv2d_cd(inc, 2*kernel_size*kernel_size, kernel_size=3, padding=1, stride=stride)
        # nn.init.constant_(self.p_conv.weight, 0)
        self.p_conv.register_backward_hook(self._set_lr)
...
class HighResolutionNet(nn.Module):
    ...
    def __init__(self, config, **kwargs):
        ...
        self.dc0 = DeformConv2dcd(48,48)
        self.dc1 = DeformConv2dcd(96,96)
        self.dc2 = DeformConv2dcd(192,192)
        self.dc3 = DeformConv2dcd(384,384)
        self.FSM = FeatureSelectionModule(384,180)
        self.fpn_out = Conv2d(48, 48,3,bn=True, bias=False, same_padding=True)
...
def get_seg_model(**kwargs):
    ...
    update_config(hr_config, './seg_hrnet_w48.yaml')
...
#     out = model(torch.rand(1,3,640,640).cuda())
#     print(out.size())
